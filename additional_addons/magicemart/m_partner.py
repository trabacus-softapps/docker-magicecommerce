...
#             s_sequence=self.pool.get('ir.sequence').get(cr, uid,'m.supplier')
#             vals['seq_num']=s_sequence
#               
#         # ********************* cutomer payable*****************************  
#         if context.get('search_default_customer', False):
#             c_sequence=self.pool.get('ir.sequence').get(cr, uid,'m.customer')
#             vals['seq_num']=c_sequence
