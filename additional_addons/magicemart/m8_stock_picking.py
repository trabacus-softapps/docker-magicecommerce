...
class stock_quant(osv.osv):
    ...
    # Overriden  stock Valuation (not to create journal entry for internal transfer)
    def _account_entry_move(self, cr, uid, quants, move, context=None):
        ...
        if company_to and (move.location_id.usage not in ('internal', 'transit') and move.location_dest_id.usage == 'internal' and company_from != company_to):
            ctx = context.copy()
        ...
        if company_from and (move.location_id.usage == 'internal' and move.location_dest_id.usage not in ('internal', 'transit') and company_from != company_to):
            ctx = context.copy()
